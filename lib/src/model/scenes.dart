...
enum WeatherScene {
  ...
  Widget get sceneWidget => WeatherSceneWidget(weatherScene: this);

  @Deprecated(
    'Use [sceneWidget] instead. Will be removed in the next release.',
  )
  Widget getWeather() => sceneWidget;
}

@Deprecated(
  'Use [WeatherSceneWidget] instead. Will be removed in the next release.',
)
Widget getWeatherScene(WeatherScene weatherScene) =>
    WeatherSceneWidget(weatherScene: weatherScene);

class WeatherSceneWidget extends StatelessWidget {
  const WeatherSceneWidget({super.key, required this.weatherScene});
